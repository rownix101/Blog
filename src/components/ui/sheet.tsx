    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === 'top' &&
            'data-[state=closed]:slide-out-to-top-0 data-[state=open]:slide-in-from-top-0 inset-x-0 top-0 h-auto border-b',
          side === 'bottom' &&
            'data-[state=closed]:slide-out-to-bottom-0 data-[state=open]:slide-in-from-bottom-0 inset-x-0 bottom-0 h-auto border-t',
          className,
        )}
        {...props}
      >
