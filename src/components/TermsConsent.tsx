...
export function TermsConsent({ lang }: TermsConsentProps) {
    ...
    useEffect(() => {
        ...
        const isPolicyPage = window.location.pathname.includes('/privacy') || window.location.pathname.includes('/terms')
    ...
    return (
      ...
      */}
            ...
            >
                <DialogHeader>
                    <DialogTitle>{isEn ? 'Terms of Service & Privacy Policy' : '服务条款与隐私政策'}</DialogTitle>
                    <DialogDescription>
                        {isEn
                    ...
                    <p className="text-sm text-muted-foreground">
                        {isEn ? (
                            <>
                                ...
                                <a href="/en/terms" className="underline text-primary">Terms of Service</a> and{' '}
                                <a href="/en/privacy" className="underline text-primary">Privacy Policy</a>.
                            </>
                        ) : (
                            <>
                                点击“接受”即表示您同意我们的
                                <a href="/zh-cn/terms" className="underline text-primary">服务条款</a>和
                                <a href="/zh-cn/privacy" className="underline text-primary">隐私政策</a>。
                            </>
                        )}
                    </p>
                </div>
