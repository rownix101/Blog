...
export const dictionary = {
  zh: {
    ...
    auth: {
      ...
      registerSubmit: '发送验证邮件',
      loginSubmit: '发送登录链接',
      submitting: '发送中',
      checkEmail: '邮件已发送，请查收邮箱并点击链接完成操作。',
      errorGeneric: '操作失败，请稍后再试。',
      errorInvalid: '链接无效或已过期，请重新登录。',
      errorUnverified: '邮箱尚未验证，请先完成注册验证。',
      haveAccount: '已有账号？',
      noAccount: '还没有账号？',
      logout: '退出',
  ...
  en: {
    ...
    comments: {
      ...
      loginToComment: 'You need to log in to post a comment.',
    ...
    auth: {
      ...
      registerSubmit: 'Send verification email',
      loginSubmit: 'Send login link',
      submitting: 'Sending',
      checkEmail: 'Email sent. Check your inbox and click the link to continue.',
      errorGeneric: 'Something went wrong. Please try again.',
      errorInvalid: 'The link is invalid or has expired. Please log in again.',
      errorUnverified: 'Your email is not verified. Please complete registration first.',
